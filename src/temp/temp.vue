<template>
    <div style="margin: 0 auto;width: 50%;">
      ...
      <!--  添加图书按钮 -->
      <el-button type="primary" @click="add_dialog_visible = true" size="small">新增</el-button>
      <!-- 数据表格 -->
      <el-table :data="books" style="margin: 20px auto;">
        <el-table-column label="学校代码" prop="book_number"/>
        <el-table-column label="中文名" prop="book_name"/>
        <el-table-column label="级别" prop="book_type"/>
        <el-table-column label="学校类型" prop="book_prize"/>
        <el-table-column label="联系电话" prop="author"/>
        <el-table-column label="联系邮箱" prop="book_publisher"/>
        <el-table-column label="地址" prop="book_publisher"/>
